...
class FileUploaderApp(QWidget):
    ...
    def get_column_names(self):
        ...
        return {
            ...
            'PriznakSortirovki': 'Тип операции',
            ...
            'Razbrakovka_tovara': 'Сортируемый товар',
        ...
        try:
            ...
            for index, row in data.iterrows():
                ...
                payload = {
                    ...
                    # дубль — можно убрать
                    'PriznakSortirovki': self.process_op_column_value(row.get('Тип операции')),
                    ...
                    'Razbrakovka_tovara': self.process_op_column_value(row.get('Сортируемый товар')),
    ...
    def reorder_columns_by_template(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        desired_order = [
            ...
            "Тип операции", "Сборка наборов (комплектов) от 2-х штук разных товаров",
